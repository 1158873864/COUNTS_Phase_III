...
function showAllTask(directoryForAllTask,textForAllTask){
    ...
    var plForAllTask = document.getElementsByClassName("paginateForAllTask")[0];
    var prForAllTask = document.getElementsByClassName("paginateForAllTask")[1];

    plForAllTask.onclick = slideForAllTask.bind( this, -1 );
    prForAllTask.onclick = slideForAllTask.bind( this, 1 );

    var maxForAllTask=directoryForAllTask.length;							//总共max张
...
//var album=new Array();
    ...
    if(maxForAllTask==0){
        document.getElementById("noTaskAvailable2").setAttribute("style", "display:block");
        totalForAllTask=1;   //没有task也算有1页
        document.querySelector( '.counterForAllTask' ).setAttribute("style", "display:none");    //隐藏页数信息
    }
    else{
        document.getElementById("noTaskAvailable2").setAttribute("style", "display:none");
    ...
    function loadAllTask() {
        for (var i = 0; i < totalForAllTask; i++) {
            ...
            for (var j = 0; j < 3 && i * intervalForAllTask + j + 1 <= maxForAllTask; j++) {
                ...
                photo.setAttribute("onclick", "showTask(this,true)");
    ...
    function slideForAllTask(offset) {
        ...
        document.querySelector( '.counterForAllTask' ).innerHTML = ( indexForAllTask + 1 ) + ' / ' + totalForAllTask;
